"""
LatentViT v2 学習スクリプト
LayerWiseNorm / SemanticPE / LEAM のアブレーション実験対応
"""
...
from models_fer_vit.latent_vit_v2 import LatentViTv2
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train LatentViT v2 with ablation module flags")
